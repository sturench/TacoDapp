const projectConfig = {
  ...
  //  mintCost: process.env.VERCEL_ENV === 'production' ? 100 : 0.01,
  ...
  chainId: process.env.VERCEL_ENV === 'production' ? 1 : 4, // Ethereum (1), Rinkeby (4)
  network: process.env.VERCEL_ENV === 'production' ? 'mainnet' : 'rinkeby',
